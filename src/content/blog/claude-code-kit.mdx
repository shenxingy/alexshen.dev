...
The kit adds the infrastructure around it:
...
Ideas don't validate themselves. Code sitting in a branch does nothing. The kit exists in its current form because I kept using it, kept finding problems, and kept fixing them — often the same day.
...
Every feature in the kit exists because of real friction. When something feels tedious, that's signal — automate it or redesign it.
