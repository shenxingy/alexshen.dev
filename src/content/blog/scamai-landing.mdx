...
When I started working on the landing page for Scam AI, I knew I wanted something different. An AI security company that detects deepfakes, scam calls, and fraud should feel like it has teeth. Not a generic SaaS aesthetic.

What none of us knew was how many iterations it would take to get there.
...
From the beginning this was a collaborative project. I was involved in the design decisions, the architecture, and several complete rebuilds from scratch — the kind of "tear it all down and start over" cycles that only make sense in retrospect. The final version's main driver was my teammate Dennis, who brought the visual identity and execution quality that made it actually land.

What I contributed most was the thinking that happened between versions: what story the page should tell, which audiences to prioritize, what each redesign was trying to fix and why the previous one hadn't worked.
