...
The first version was functional and forgettable. Standard Next.js layout, Inter font, hero section with a tagline, three feature cards. I shipped it quickly to have something live.

The second version added dark mode and started experimenting with visual identity. Black backgrounds, high-contrast typography, a navigation that felt more like a security product than a SaaS dashboard.

This is when I started understanding the real design problem: **Scam AI serves completely different audiences**. Enterprises buying API access. Individuals worried about scam calls. Researchers interested in the underlying detection models. A single hero can't speak to all three. You have to pick who you're talking to first and trust that everyone else can find their section.

I didn't commit to that choice early enough. The page oscillated for longer than it should have.

## The Bento phase

One redesign cycle brought in a Bento grid — the card-based layout that became popular after Apple started using it. Dense, modular, visually interesting.

It worked for a while. The grid communicated "we do a lot of things" efficiently, and the visual hierarchy made it scannable. But with 8 product verticals — deepfakes, voice clones, scam text, AI-generated images, KYC verification — it started to feel like a menu rather than a pitch.
