...
Go to the [DOL's FLAG wage search tool](https://flag.dol.gov/wage-data/wage-search) and you get a searchable table. Fifty thousand rows. One metro area at a time. No way to ask "given my salary and job title, which cities work for me?"
