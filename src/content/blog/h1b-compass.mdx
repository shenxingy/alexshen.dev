...
I ended up sharing the link with a few friends who were going through the same process — adjusting the salary slider to their numbers, switching between wage levels, zooming into different regions. A few of them told me it helped them make their final call on where to live.

That was the validation I didn't expect: not just that it worked technically, but that it was actually useful for a real decision.
