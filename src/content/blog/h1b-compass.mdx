...
Go to the [DOL's OFLC wage search tool](https://www.dol.gov/agencies/eta/foreign-labor/wage-data/wage-library) and you get a searchable table. Fifty thousand rows. One metro area at a time. No way to ask "given my salary and job title, which cities work for me?"
